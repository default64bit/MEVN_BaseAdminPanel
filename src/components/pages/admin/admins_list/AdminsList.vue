    ...
    <div class="dashboard_body">
        <div class="flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <router-link
                    ...
                    v-if="checkAdminPermission(['admins.add'], adminInfo.permissions)"
                >
                ...
                <td>
                    <div class="flex items-center gap-1">
                        <router-link
                            ...
                            title="Edit"
                            v-if="checkAdminPermission(['admins.edit'], adminInfo.permissions)"
                        >
                        ...
                        <button
                            ...
                            v-if="checkAdminPermission(['admins.delete'], adminInfo.permissions)"
                        >
        ...
        <t-dialog v-model:open="filterDialogState" title="Filters">
            <template v-slot:body>
                ...
                <div class="flex flex-col">
                    <label class="text-gray-100 mb-2">Status</label>
                    <ul class="flex flex-wrap gap-2 select-none">
                        <li class="t_button py-0 gap-2 rounded-full bg-gray-700" @click="filterStatus('active')">
                            <i class="fal fa-check" v-if="filters.status.indexOf('active') != -1"></i>
                            <span class="text-lime-200">Active</span>
                        </li>
                        <li class="t_button py-0 gap-2 rounded-full bg-gray-700" @click="filterStatus('deactive')">
                            <i class="fal fa-check" v-if="filters.status.indexOf('deactive') != -1"></i>
