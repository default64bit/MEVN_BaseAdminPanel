<template>
    <div class="dashboard_body max-w-screen-xl mx-auto bg-truegray-800 shadow-2xl">
        <div class="flex flex-wrap justify-between items-center gap-4">
            <h1 class="text-white text-4xl"><b>Create New Role</b></h1>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-4">
            <button class="t_button t_button_min bg-violet-400 hover:bg-violet-500 disabled:opacity-50" :disabled="creatingRole" @click="create()">
...
export default {
    ...
    methods: {
        ...
        create() {
            ...
            axios
                .post(`${this.getBaseUrl()}/api/v1/admin/roles`, {
